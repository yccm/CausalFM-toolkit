"""
Trainer for Instrumental Variables setting.
"""
...
from causalfm.data.loaders import create_iv_dataloader
from src.tabpfn.model.causalFM4IV import PerFeatureTransformerCATE as PerFeatureTransformerIV


class IVTrainer(BaseTrainer):
    """
    Trainer for Instrumental Variables setting.
    
    Trains the PerFeatureTransformerIV model on IV datasets.
    ...
    def _create_model(self) -> nn.Module:
        """Create the IV model."""
        return PerFeatureTransformerIV(
    ...
    def _train_step(self, batch: Dict) -> Tuple[torch.Tensor, Dict]:
        ...
        # Forward pass
        out = self.model(x, z, a, y, single_eval_pos)

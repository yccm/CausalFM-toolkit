"""
Trainer for Standard CATE estimation.
"""
...
from causalfm.data.loaders import create_standard_dataloader
from src.tabpfn.model.causalFM import PerFeatureTransformerCATE


class StandardCATETrainer(BaseTrainer):
    """
    Trainer for Standard CATE estimation.
    
    Trains the PerFeatureTransformerCATE model on standard CATE
    estimation datasets.
    ...
    def __init__(self, config: TrainingConfig):
        """
        Initialize the Standard CATE trainer.
    ...
    def _create_model(self) -> nn.Module:
        """Create the CATE model."""
        return PerFeatureTransformerCATE(

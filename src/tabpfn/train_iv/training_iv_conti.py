# Training for IV setting with continuous Z
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default="DATA_IV/conti_Z/synthetic*.csv",
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints_IV_conti',

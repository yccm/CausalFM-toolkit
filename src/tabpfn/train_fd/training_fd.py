# Training for Frontdoor Adjustment Setting
...
from DATA_FD.causaldatasetFD import create_causal_data_loaders
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train Frontdoor Adjustment setting CATE estimation model with CausalFM')
    parser.add_argument('--data_path', type=str, default="DATA_FD/frontdoor/synthetic*.csv",
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints_FD',
    ...
    def train_epoch(self, epoch):
        ...
        with tqdm(self.train_loader, desc=f"Epoch {epoch+1}/{self.args.epochs} [Train]") as pbar:
            for batch_idx, batch in enumerate(pbar):
                ...
                m = batch['m'].to(self.device)  # Mediator

...
from DATA_standard.causaldataset import create_causal_data_loaders
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train standard CATE estimation model with CausalFM')

    parser.add_argument('--data_path', type=str, default="DATA_standard/data_normalized/normalized*.csv",
...
class CATETrainer:
    ...
    def train_epoch(self, epoch):
        ...
        with tqdm(self.train_loader, desc=f"Epoch {epoch+1}/{self.args.epochs} [Train]") as pbar:
            for batch_idx, batch in enumerate(pbar):
                ...
                out = self.model(x, a, y, single_eval_pos)  
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            # Validate
            val_loss, rmse = self.validate(epoch)
            ...
            # Log to tensorboard
            self.log_metrics(epoch, train_loss, val_loss, rmse)
